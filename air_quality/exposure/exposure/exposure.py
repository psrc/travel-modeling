...
# We don't have data for missing hours, so maybe we should just copy them
[21,22,23,24,0,1,2,3,4]

_parcel_tot_df[_parcel_tot_df['hourID'].isin(range(_df['begin_hour'],_df['end_hour']+1))]

len_added = 5
_parcel_tot_df = _parcel_tot_df.append([_parcel_tot_df.loc[_parcel_tot_df.hourID == len_added]]*5,ignore_index=True)
# Select
_parcel_tot_df.iloc[-len_added]